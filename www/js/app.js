...
LightHouse.controller('ReflectionCtrl', ['$scope', '$state', 'ListFactory','reflectionService', function ($scope, $state, ListFactory,reflectionService)
    {
        var goals = ListFactory.getList();
        $scope.goals = goals;
        ...
        console.log($scope.numCompleted);
